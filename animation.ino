    ...
    switch (n) {
      ...
      case 5:
        ...
        break;
              case 6:
        // EFFECT_ANIMATION_6
        loadImage(kopibara_array[frameNum]);
        if (++frameNum >= sizeof(kopibara_array) / sizeof(kopibara_array[0])) frameNum = 0;
        break;
                      case 7:
        // EFFECT_ANIMATION_7
        loadImage(amogus_array[frameNum]);
        if (++frameNum >= sizeof(amogus_array) / sizeof(amogus_array[0])) frameNum = 0;
        break;
